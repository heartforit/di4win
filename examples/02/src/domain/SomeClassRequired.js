...
let SomeClassRequired = exports.SomeClassRequired = (() => {
    ...
    let _classThis;
    var SomeClassRequired = _classThis = class {
        constructor() {
        }
        sayHello() {
    ...
    __setFunctionName(_classThis, "SomeClassRequired");
    (() => {
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name }, null, _classExtraInitializers);
        SomeClassRequired = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SomeClassRequired = _classThis;
})();
